...
<div class="container">
    <div class="row">
        <div class="col-sm-12 text-center">
            <img src="<?php echo base_url("/assets/images/SOLVE.png") ?>"  style="margin: auto;width: 200px;display: block"/>
    ...
    <div class="col-sm-6 col-sm-offset-3" align="center">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <a class="btn btn-lg btn-danger btn-block" href="<?=base_url('assets/uploads/files/com.limadigit.solve.apk')?>">
