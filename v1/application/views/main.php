    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<?=site_url('/events/form')?>">Form Data</a></li>
                <li><a href="<?=site_url('/users')?>">Manage Users</a></li>
                <li><a href="<?=site_url('/manage_admin')?>">Setup Admin & Stocks</a></li>
                <?php } ?>
                <?php
                if($status=="admin"){
                ?>
                    <li><a href="<?=site_url('/admin')?>">Dashboard</a></li>
                    <li><a href="<?=site_url('/users')?>">Manage TL</a></li>
                <?php
                }
                if($status=="tl"){ ?>
                    <li><a href="<?=site_url('/admin')?>">Dashboard</a></li>
                    <li><a href="<?=site_url('/users')?>">Manage SPG</a></li>
                <?php } ?>
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="background-color:transparent;color:#fff"><?php echo ucfirst($username); ?> (<?=$status?>)<span class="caret"></span></a>
