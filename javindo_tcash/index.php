		...
		<div class="col-md-6 col-md-offset-3" align="center">
				<ul class="ds-btn">					
					<li>
						...
						<i class="glyphicon glyphicon-user pull-left"></i><span>Login SPG<br><small style="font-size:10px">Login yang digunakan <br/>SPG untuk mengambil data.</small></span></a> 						
					</li>
					<li>
