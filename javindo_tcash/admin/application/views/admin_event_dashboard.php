...
<script>
	...
	function data_user(resp) {
		...
		if(result.data_user.length > 0) {
			...
			html += '<tr class="odd gradeX">'+
								'<td colspan="6" align="center">There\'s no data</td>'+
							'</tr>';
			$("#all_user").html(html);
		}
	}
	...
	function data_merchant(resp) {
		...
		if(result.data_merchant.length > 0) {
			...
			html += '<tr class="odd gradeX">'+
								'<td colspan="8" align="center">There\' no data</td>'+
							'</tr>';
...
<!--			<form class="form-horizontal" method="post" action="--><?php //echo base_url() ?><!--#">-->
				<div class="form-inline">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<div class="input-group" style="max-width:200px">
							  <input type="text" name="startDate" value="<?=date('Y-m-d',strtotime(date('Y-m-d').' -6days'))?>" id="datepicker" class="form-control" required placeholder="Start Date">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<div class="input-group" style="max-width:200px">
								<input type="text" name="endDate" value="<?=date('Y-m-d')?>" id="datepicker2" class="form-control" required placeholder="End Date">
								<span class="input-group-addon" id="dating"><i class="fa fa-calendar"></i></span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8"><input type="button" value="Export to Excel" class="btn btn-success" id="export" /></div>
					</div>
				</div>
				<br>
