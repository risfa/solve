...
//                $this->db->query("update ms_user set created_by='".$data['username']."' where created_by='".$old."' ");
//                $this->db->query("update ms_merchant set created_by='".$data['username']."' where created_by='".$old."' ");
